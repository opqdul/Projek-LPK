...
def tentang():
    ...
    st.write("""
    Aplikasi web ini dibuat dengan tujuan utama untuk *memudahkan pelajar dan mahasiswa dalam memahami serta mengklasifikasikan gugus fungsi dalam senyawa organik*. Dalam pembelajaran kimia organik, pengenalan struktur senyawa dan pengklasifikasian gugus fungsinya seringkali menjadi tantangan, terutama bagi pemula. Oleh karena itu, aplikasi ini hadir sebagai media interaktif yang dapat membantu pengguna mengidentifikasi berbagai gugus fungsi seperti alkohol, eter, aldehid, keton, asam karboksilat, dan lain-lain secara lebih mudah dan cepat.
...
st.write(option)
st.write(option.find("Tentang"))
if option == "Indentifikasi Gugus Fungsi":
    identifikasi()
if option.find("Tentang Aplikasi") == 0:
